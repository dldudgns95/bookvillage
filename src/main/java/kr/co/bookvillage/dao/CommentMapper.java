...
public interface CommentMapper {
  ...
  public int insertAnswer(AnswerDto ans);
  public int getAnswerCount(int ansNo);
  
  public List<AnswerDto> getAnsList(Map<String, Object> map);
  public int insertAnsReply(AnswerDto ans);
  public int deleteAns(int asnNo);
