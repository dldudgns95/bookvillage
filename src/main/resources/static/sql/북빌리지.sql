...
CREATE SEQUENCE GOOD_SEQ NOCACHE;
...
CREATE SEQUENCE ASK_IMAGE_T_SEQ NOCACHE;
...
-- 1:1 문의 이미지
CREATE TABLE ASK_IMAGE_T (
	ASK_NO	                NUMBER	            NULL,      --문의 번호
	IMAGE_PATH	            VARCHAR2 (300 BYTE)	NOT NULL,  --경로
	FILESYSTEM_NAME	    VARCHAR2 (300 BYTE)	NOT NULL,  --저장된 이름
...
CREATE TABLE BOOK_CHECKOUT (
  ...
  CONSTRAINT FK1_BOOK_CHECKOUT FOREIGN KEY(USER_NO) REFERENCES USER_T(USER_NO) ON DELETE CASCADE,
  CONSTRAINT FK2_BOOK_CHECKOUT FOREIGN KEY(ISBN) REFERENCES BOOK(ISBN) ON DELETE CASCADE
);
...
INSERT INTO INACTIVE_USER (USER_NO, EMAIL, PW, NAME, MOBILE, GENDER, AGREE, STATE, AUTH, PW_MODIFIED_DATE, JOINED_DATE, INACTIVE_DATE,  STATUS, BOOKCOUNT)
VALUES (USER_T_SEQ.NEXTVAL, 'user13@naver.com', STANDARD_HASH('1313', 'SHA256'), 'User13', '010-1313-1313', 0, 0, 0, 1, '2021-01-01', '2020-12-12', '2022-05-01', 0, 0);
commit;
...
=======
>>>>>>> dbbe11eadd3754b66e271984c769966042ad22a6
commit;
